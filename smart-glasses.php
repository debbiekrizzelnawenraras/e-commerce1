      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown me-2">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#">Smart-Glasses</a></li>
            ...
            <li><a class="dropdown-item" href="moregadgets.php">More Gagets</a></li>
          </ul>
        </li>
...
<div class="container">
    <h1 class="mt-5 mb-4 text-center">Smart-Glasses</h1>

    <div class="card card-custom border-warning">
        <div class="row g-0"> 
                
            <div class="col-md-6 card-img-container"> 
                <img src="Image/Smart-Glasses.png.webp" class="img-fluid rounded-start h-100 w-75" alt="Gadgets on display">
            </div>
                
            <div class="col-md-6"> 
                <div class="card-body">
                    <h5 class="card-title-center mt-5 mb-4">The Smart-Glasses you may have</h5>
                    <p class="card-text">
                            Smart-Glasses are electronic eyeglasses that contain transparent displays and communication technology (like Wi-Fi, Bluetooth, and cellular data). They function as a hands-free, heads-up display (HUD), allowing users to interact with digital data, stream media, and communicate without looking down at a phone.
                    <!-- <p class="card-text">
                        Our team of tech experts rigorously tests every product, ensuring you invest in quality that lasts. We're not just selling products; we're providing solutions that enrich your digital life.
                    </p> -->
                    <p class="card-text">
