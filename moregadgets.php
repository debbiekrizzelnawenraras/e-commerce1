  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item button dropdown me-2">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="#">More Gadgets</a></li>
          </ul>
        </li>
      ...
      <form class="d-flex" role="Login/Register">
        <button class="btn btn-outline-success bg-light" type="Login/Register"><i class="bi bi-door-closed-fill"></i></i><a href="auth/logout.php">Logout</button>
      </form>
...
<main class="container my-5">
    <h1 class="text-center mb-5 text-primary">Our Complete Product Lineup</h1>
    ...
    <!-- <div class="row g-4"> -->
      <div class="card card-custom border-warning">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card h-100 text-center d-flex=auto">
                    <!-- <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button> -->
                <img src="Image/moregadgets1.avif" class="card-img-top p-3" alt="Nova Watch X">
                <div class="card-body d-flex flex-column">
                    <h5 class="card-title text-black">Nova Watch X</h5>
                    <p class="small text-warning mb-1">
                      <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-half"></i>
                    </p>
                    <p class="h5 fw-bold text-success mb-2">$299.99</p>
                    <p class="card-text small mb-4">The ultimate health and productivity companion.</p>
                    <a href="addtocart.php" class="btn btn-primary mt-auto"><i class="bi bi-cart-plus-fill"></i>Add to Cart</a>
                </div>
            </div>
        </div>
        <!-- Product 2 -->
        <div class="col-sm-6 col-lg-3">
            <div class="card h-100 text-center d-flex=auto">
                <img src="Image/moregadgets2.jpg" class="card-img-top p-3" alt="Aura Drone Pro">
                <div class="card-body d-flex flex-column">
                    <h5 class="card-title text-black">Aura Drone 7 Pro</h5>
                    <p class="small text-warning mb-1">
                      <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star"></i>
                    </p>
                    <p class="h5 fw-bold text-success mb-2">$1,299.00</p>
                    <p class="card-text small mb-4">Professional-grade aerial filming and long-range.</p>
                    <a href="addtocart.php" class="btn btn-primary mt-auto"><i class="bi bi-cart-plus-fill"></i>Add to Cart</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card h-100 text-center d-flex=auto">
                <img src="Image/moregadgets3.webp" class="card-img-top p-3 h-50" alt="Cypher Earbuds">
                <div class="card-body d-flex flex-column">
                    <h5 class="card-title text-black">Cypher Noise-Cancel</h5>
                    <p class="small text-warning mb-1">
                      <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-half"></i>
                    </p>
                    <p class="h5 fw-bold text-success mb-2">$149.50</p>
                    <p class="card-text small mb-4">Deep bass and industry-leading noise cancellation.</p>
                    <a href="addtocart.php" class="btn btn-primary mt-auto"><i class="bi bi-cart-plus-fill"></i>Add to Cart</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card h-100 text-center d-flex=auto">
                <img src="Image/moregadgets4.avif" class="card-img-top p-3" alt="Nexus VR">
                <div class="card-body d-flex flex-column">
                    <h5 class="card-title text-black">Nexus VR Headset</h5>
                    <p class="small text-warning mb-1">
                      <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star"></i>
                    </p>
                    <p class="h5 fw-bold text-success mb-2">$799.00</p>
                    <p class="card-text small mb-4">True 8K immersive visual fidelity.</p>
                    <a href="addtocart.php" class="btn btn-primary mt-auto"><i class="bi bi-cart-plus-fill"></i>Add to Cart</a>
                </div>
            </div>
        </div>
        ...
        <!-- Product 5 -->
         <div class="col-sm-6 col-lg-3">
            <div class="card h-100 text-center d-flex=auto">
                <img src="Image/moregadgets5.jpg" class="card-img-top p-3" alt="Nexus VR">
                <div class="card-body d-flex flex-column">
                    <h5 class="card-title text-black">Aura ANC Headphones</h5>
                    <p class="small text-warning mb-1">
                      <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-half"></i>
                    </p>
                    <p class="h5 fw-bold text-success mb-2">$199.99</p>
                    <p class="card-text small mb-4">Industry-leading noise cancellation with 30-hour battery life and memory foam cups.</p>
                    <a href="addtocart.php" class="btn btn-primary mt-auto"><i class="bi bi-cart-plus-fill"></i>Add to Cart</a>
                </div>
            </div>
        </div>
      <!-- Product 6 -->
       <div class="col-sm-6 col-lg-3">
            <div class="card h-100 text-center d-flex=auto">
                <img src="Image/moregadgets6.jpg" class="card-img-top p-3" alt="Nexus VR">
                <div class="card-body d-flex flex-column">
                    <h5 class="card-title text-black">Pico Cinema Projector</h5>
                    <p class="small text-warning mb-1">
                      <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star"></i>
                    </p>
                    <p class="h5 fw-bold text-success mb-2">$299.50</p>
                    <p class="card-text small mb-4">Pocket-sized projector with 1080p resolution and built-in Android OS for streaming anywhere.</p>
                    <a href="addtocart.php" class="btn btn-primary mt-auto"><i class="bi bi-cart-plus-fill"></i>Add to Cart</a>
                </div>
            </div>
        </div>
        ...
        <!-- Product 7 -->
         <div class="col-sm-6 col-lg-3">
          <div class="card h-100 text-center d-flex=auto">
                  <img src="Image/moregadgets7.jpg" class="img-fluid" alt="Home Security Camera">
              <!-- <div class="card-body"> -->
                  <div class="card-body d-flex flex-column">
                      <h5 class="card-title text-black">Guardian Cam 360</h5>
                      <p class="small text-warning mb-1">
                          <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                      </p>
                      <p class="h5 fw-bold text-success mb-2">$89.99</p>
                      <p class="card-text small mb-4">Full 360° coverage and night vision. You can monitor your family and makes you reliev for their safety even though you are far away from your home and love ones<i class="bi bi-arrow-through-heart-fill"></i>.</p>
                    <a href="addtocart.php" class="btn btn-primary mt-auto"><i class="bi bi-cart-plus-fill"></i>Add to Cart</a> 
                  </div>
              <!-- </div> -->
          </div>
