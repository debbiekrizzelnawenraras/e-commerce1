...
<div class="container">
    <h1 class="mt-5 mb-4 text-center">Smart-Phone</h1>

    <div class="card card-custom border-warning">
        <div class="row g-0"> 
                
            <div class="col-md-6 card-img-container"> 
                <img src="Image/Smart-Phone.webp" class="img-fluid rounded-start h-100 w-100" alt="Gadgets on display">
            </div>
                
            <div class="col-md-6"> 
                <div class="card-body">
                    <h5 class="card-title mt-5 mb-4">The Smart-Watch you Want to Have</h5>
                    <p class="card-text">
                      A smartphone is a mobile device that combines the features of a mobile phone (calls, messages) with the computing functionality of a personal computer. They are primarily defined by their use of a powerful operating system and a capacitive touchscreen interface.
                    </p>
                    <p class="card-text">
                      It is essentially the hub that manages the data and communication for the smartwatches, smart-glasses, and almost every other device you own. It provides the user interface and the processing power that those smaller devices often offload.
                    </p>
                    <p class="card-text">
