...
<!-- this is for its content -->
    <div class="modal-body p-4">
      <div id="cart-items-container">
        </div>
      <div id="cart-empty-message" class="text-center py-5">
        <i class="bi bi-bag-x display-4 text-muted mb-3"></i>
          <p class="lead text-muted">Your cart is empty. Time to shop!</p>
      </div>
    </div>
     <div class="modal-footer d-flex justify-content-between">
          <div class="fw-bold fs-5">Total: <span id="cart-total-price" class="text-primary">$0.00</span></div>
